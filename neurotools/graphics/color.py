...
asarray = lambda s:np.array(mpl.colors.to_rgb(s))
WHITE      = asarray('#f1f0e9')
RUST       = asarray('#eb7a59')
OCHRE      = asarray('#eea300')
AZURE      = asarray('#5aa0df')
TURQUOISE  = asarray('#00bac9')
TEAL       = TURQUOISE
BLACK      = asarray('#44525c')
YELLOW     = asarray('#efcd2b')
INDIGO     = asarray('#606ec3')
VIOLET     = asarray('#8d5ccd')
MAUVE      = asarray('#b56ab6')
MAGENTA    = asarray('#cc79a7')
CHARTREUSE = asarray('#b59f1a')
MOSS       = asarray('#77ae64')
VIRIDIAN   = asarray('#11be8d')
CRIMSON    = asarray('#b41d4d')
GOLD       = asarray('#ffd92e')
TAN        = asarray('#765931')
SALMON     = asarray('#fa8c61')
GRAY       = asarray('#b3b3b3')
LICHEN     = asarray('#63c2a3')
DUSK       = asarray('#1e61a1')
